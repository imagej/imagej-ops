...
public class RealArccsc< I extends RealType< I >, O extends RealType< O >> extends AbstractFunction< I, O >
		implements Arccsc
{
	private static final RealArccos< DoubleType, DoubleType > acos = new RealArccos< DoubleType, DoubleType >();
