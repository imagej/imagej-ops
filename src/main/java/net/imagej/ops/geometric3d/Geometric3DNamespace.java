...
public class Geometric3DNamespace extends AbstractNamespace {
	...
	public <B extends BooleanType<B>> DoubleType Compactness(final IterableRegion<B> in) {
		final DoubleType result =
			(DoubleType) ops().run(net.imagej.ops.geometric3d.DefaultCompactnessFeature.class, in);
		return result;
	}
	...
	public <B extends BooleanType<B>> DoubleType ConvexHullSurfaceArea(final IterableRegion<B> in) {
		final DoubleType result =
			(DoubleType) ops().run(net.imagej.ops.geometric3d.DefaultConvexHullSurfaceAreaFeature.class, in);
		return result;
	}
	...
	public <B extends BooleanType<B>> DoubleType ConvexHullSurfacePixel(final IterableRegion<B> in) {
		final DoubleType result =
			(DoubleType) ops().run(net.imagej.ops.geometric3d.DefaultConvexHullSurfacePixelFeature.class, in);
		return result;
	}
	...
	public <B extends BooleanType<B>> DoubleType ConvexHullVolume(final IterableRegion<B> in) {
		final DoubleType result =
			(DoubleType) ops().run(net.imagej.ops.geometric3d.DefaultConvexHullVolumeFeature.class, in);
		return result;
	}
	...
	public <B extends BooleanType<B>> DoubleType Convexity(final IterableRegion<B> in) {
		final DoubleType result =
			(DoubleType) ops().run(net.imagej.ops.geometric3d.DefaultConvexityFeature.class, in);
		return result;
	}
	...
	public <B extends BooleanType<B>> DoubleType MainElongation(final IterableRegion<B> in) {
		final DoubleType result =
			(DoubleType) ops().run(net.imagej.ops.geometric3d.DefaultMainElongationFeature.class, in);
		return result;
	}
	...
	public <B extends BooleanType<B>> DoubleType MedianElongation(final IterableRegion<B> in) {
		final DoubleType result =
			(DoubleType) ops().run(net.imagej.ops.geometric3d.DefaultMedianElongationFeature.class, in);
		return result;
	}
	...
	public <B extends BooleanType<B>> DoubleType Rugosity(final IterableRegion<B> in) {
		final DoubleType result =
			(DoubleType) ops().run(net.imagej.ops.geometric3d.DefaultRugosityFeature.class, in);
		return result;
	}
	...
	public <B extends BooleanType<B>> DoubleType Solidity(final IterableRegion<B> in) {
		final DoubleType result =
			(DoubleType) ops().run(net.imagej.ops.geometric3d.DefaultSolidityFeature.class, in);
		return result;
	}
	...
	public <B extends BooleanType<B>> DoubleType Spareness(final IterableRegion<B> in) {
		final DoubleType result =
			(DoubleType) ops().run(net.imagej.ops.geometric3d.DefaultSparenessFeature.class, in);
		return result;
	}
	...
	public <B extends BooleanType<B>> DoubleType Sphericity(final IterableRegion<B> in) {
		final DoubleType result =
			(DoubleType) ops().run(net.imagej.ops.geometric3d.DefaultSphericityFeature.class, in);
		return result;
	}
	...
	public <B extends BooleanType<B>> DoubleType SurfaceArea(final IterableRegion<B> in) {
		final DoubleType result =
			(DoubleType) ops().run(net.imagej.ops.geometric3d.DefaultSurfaceAreaFeature.class, in);
		return result;
	}
	...
	public <B extends BooleanType<B>> DoubleType SurfacePixel(final IterableRegion<B> in) {
		final DoubleType result =
			(DoubleType) ops().run(net.imagej.ops.geometric3d.DefaultSurfacePixelFeature.class, in);
		return result;
	}
	...
	public <B extends BooleanType<B>> DoubleType Volume(final IterableRegion<B> in) {
		final DoubleType result =
			(DoubleType) ops().run(net.imagej.ops.geometric3d.DefaultVolumeFeature.class, in);
		return result;
	}
	
	@OpMethod(op = net.imagej.ops.descriptor3d.QuickHull3DFromMC.class)
	public <B extends BooleanType<B>> DefaultFacets convexhull3d(final MarchingCubes<B> in) {
		final DefaultFacets result =
			(DefaultFacets) ops().run(net.imagej.ops.descriptor3d.QuickHull3DFromMC.class, in);
		return result;
	}
	...
	public DefaultFacets convexhull3d(final HashSet<Vertex> in) {
		final DefaultFacets result =
			(DefaultFacets) ops().run(net.imagej.ops.descriptor3d.QuickHull3D.class, in);
		return result;
	}
}
