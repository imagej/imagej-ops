...
public interface OpResolverService extends Service {
	...
	<I> ResolvedOpSet<I> build(final I input, OpRef<?>... refs);

	<I, O> ResolvedOp<I, O> resolveAndRun(final Class<O> outType,
			final I input,
			@SuppressWarnings("rawtypes") final Class<? extends OutputOp> type,
			final Object... args);

	<I, O> ResolvedOp<I, O> resolveAndRun(final Class<O> outType, final I input,
