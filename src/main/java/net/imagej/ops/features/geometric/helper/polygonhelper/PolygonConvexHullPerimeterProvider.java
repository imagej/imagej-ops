...
import net.imagej.ops.statistics.geometric.GeometricStatOps.Perimeter;
...
public class PolygonConvexHullPerimeterProvider implements Feature {
	...
	@Override
	public void run() {
		out = ((DoubleType) ops.run(Perimeter.class, in.getOutput()))
				.getRealDouble();
	}
