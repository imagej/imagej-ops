 ...
 */
@Plugin(type = Op.class, name = HuMoment5Feature.NAME, label = HuMoment5Feature.LABEL)
public class DefaultHuMoment5Feature implements HuMoment5Feature<DoubleType> {
    ...
    public void run() {
        ...
        out.setReal((n30.getOutput().getRealDouble() - 3 * n12.getOutput()
                .getRealDouble())
                ...
                * (Math.pow(n30.getOutput().getRealDouble()
                ...
                + (3 * n21.getOutput().getRealDouble() - n03.getOutput()
                        .getRealDouble())
