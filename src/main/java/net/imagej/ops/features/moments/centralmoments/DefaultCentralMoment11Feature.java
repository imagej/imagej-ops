 ...
 */
@Plugin(type = Op.class, name = CentralMoment11Feature.NAME)
public class DefaultCentralMoment11Feature implements CentralMoment11Feature {
	...
	@Override
	public void run() {
		out = centralMomentsHelper.getOutput().getCentralMoment11();
	}
