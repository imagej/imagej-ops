 ...
 */
@Plugin(type = Op.class, name = CentralMoment10Feature.NAME)
public class DefaultCentralMoment10Feature implements CentralMoment10Feature {
	...
	@Override
	public void run() {
		out = centralMomentsHelper.getOutput().getCentralMoment10();
	}
