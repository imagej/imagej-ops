...
/**
 * Tests for the {@link EulerCharacteristic26NFloating EulerCharacteristic26NFloating} class
 *
...
public class EulerCharacteristic26NFloatingTest extends AbstractOpTest {
    ...
    public void testHandleCube() throws Exception {
        ...
        final Double result = ops.topology().eulerCharacteristic26NFloating(cube);
